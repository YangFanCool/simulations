...
sequence1 = list(range(100, 401, 100))
sequence2 = list(range(150, 251, 10))
combined_sequence = sorted(set(sequence1 + sequence2))
timesteps_list = [f'{num:05}' for num in combined_sequence]
